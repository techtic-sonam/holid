...
function activate_holid() {
    ...
    if (@file_exists($head_tag)) {
        ...
        $adsdatas = wp_remote_get( 'https://holid.io./ads.txt' );
        $adsdata = wp_remote_retrieve_body( $adsdatas );
...
class holid_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        echo wp_kses_post( '<div class="holidAds '.$ads_section.'"></div>', 'holid' );
...
function holid_ads_code($attrs){
    ...
    if($attrs['ads_section'] != ''){
      echo wp_kses_post( '<div class="holidAds '.$attrs['ads_section'].'"></div>', 'holid' );
    }   
}